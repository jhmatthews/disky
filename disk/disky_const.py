...
VERY_BIG = 1e50                 # A number which makes things significantly larger
H = 6.6262e-27                  # Planck's constant
HC = 1.98587e-16                # Planck's constant * Speed of light
...
BOLTZMANN = 1.38062e-16         # Boltzmann constant
WIEN =        5.879e10          # NSH 1208 Wien Disp Const in frequency units 
H_OVER_K = 4.799437e-11
STEFAN_BOLTZMANN = 5.6696e-5    # Stefan boltzmann constant
THOMPSON = 0.66524e-24          # Thompson cross-section for an electron
PI  =    3.1415927  
MELEC =  9.10956e-28
E=        4.8035e-10            # Electric charge in esu 
MPROT =   1.672661e-24          # Proton mass
MSOL =        1.989e33          # Solar mass in grammes!
RSOL = 6.995e10                 # Solar radius in cm
LSOL = 3.839e33                 # Solar Luminosity in erg/s
P =        3.08e18  
YR   =        3.1556925e7       # Number of seconds in a year
